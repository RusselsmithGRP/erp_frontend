...
class update extends Component {
  ...
  componentDidMount() {
    ...
    poActions.fetchPurchaseOrderById(this.props.user.token, id, docs => {
      this.setState({
        docs,
        poNumber: docs.po.no,
        vendor: docs.po.vendor.general_info.company_name,
        eid: docs.po.requestor.eid,
        status: docs.po.status,
        vendorId: docs.po.vendor._id
      });
      const { classes } = this.props;
      this.handleChange(event);
      let itemsprice = this.state.checkeditemsprice;
                ...
                <CardBody>
                  <Grid container>
                    ...
                    <GridItem xs={12} sm={12} md={4} style={generalStyle.text2}>
                      Purchase Order No: {this.state.poNumber}
                    </GridItem>
                    ...
                    <GridItem xs={12} sm={4} md={4}>
                      <CustomInput
                        ...
                        inputProps={{
                          value: Status.getStatus(this.state.status),
                          disabled: true
                        }}
                      />
                    </GridItem>
