    ...
    <div className={classes.root}>
      <div className={classes.center}>
        <Card className={classes.card} elevation={5}>
          ...
          <h2>Welcome to RS EDGE!</h2>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Russelsmith's Website, located at
            <a
              style={{ color: "#333" }}
          ...
          <p>
            ...
            conditions. Do not continue to use RS EDGE if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing RS EDGE, you agreed to
            use cookies in agreement with the Russelsmith's Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, Russelsmith and/or its licensors own the
            intellectual property rights for all material on RS EDGE. All
            intellectual property rights are reserved. You may access this from
            RS EDGE for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from RS EDGE</li>
            <li>Sell, rent or sub-license material from RS EDGE</li>
            <li>Reproduce, duplicate or copy material from RS EDGE</li>
            <li>Redistribute content from RS EDGE</li>
          </ul>
          ...
          <p>
            ...
            Russelsmith does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Russelsmith,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            Russelsmith shall not be liable for the Comments or for any
          ...
          <p>
            You hereby grant Russelsmith a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Russelsmith;
          ...
          <p>
            ...
            sending an e-mail to Russelsmith. Please include your name, your
